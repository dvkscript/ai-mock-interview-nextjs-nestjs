...
const ChatSection: React.FC<ChatSectionProps> = ({
    ...
    const renderAvatar = (role: "user" | "assistant") => {
        ...
        return (
            <div className="w-8 h-8 rounded-full overflow-hidden bg-gray-300 dark:bg-gray-600 flex items-center justify-center ml-2 flex-shrink-0 border border-gray-200 dark:border-gray-700">
