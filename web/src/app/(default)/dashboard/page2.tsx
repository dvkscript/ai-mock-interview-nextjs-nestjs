...
export default async function Dashboard() {
  ...
  if (!jobsRes.ok || !jobsRes.data) {
    throw new Error(jobsRes.status.toString())
  }

  const { count, rows } = jobsRes.data;
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 transform transition-all duration-300 hover:shadow-xl">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">7.8/10</p>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        <AddInterviewModal
                          trigger={
                            <button
                              type="button"
                              className="inline-flex items-center justify-center px-4 py-2 bg-white text-blue-600 rounded-lg font-medium text-sm hover:bg-blue-50 transition-colors"
                            >
                              Phỏng vấn mới
                            </button>
                          }
                        />
                        <button
                          className="inline-flex items-center justify-center px-4 py-2 border border-white/30 bg-white/10 backdrop-blur-sm text-white rounded-lg font-medium text-sm hover:bg-white/20 transition-colors"
                        >
                          Xem gợi ý
                        </button>
                      </div>
