...
const RecentInterviewsSection = ({ jobs }: { jobs: Job[] }) => (
  <div className="relative group">
    <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-200"></div>
    <Card className="relative overflow-hidden border-0 bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
      <CardContent className="p-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {interview.averageScore && (
                      <span className="px-3 py-1 text-sm rounded-full bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400">
...
const FreeTrialStatus = ({ jobs, remainingInterviews }: { jobs: Job[]; remainingInterviews: number }) => (
  <div className="relative group">
    <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-200"></div>
    <Card className="relative overflow-hidden border-0 bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
      <CardContent className="p-8">
...
export function FreeUserDashboard({ jobs, onUpgrade }: FreeUserDashboardProps) {
  const remainingInterviews = Math.max(0, 1 - jobs.length);
  const canCreateInterview = remainingInterviews > 0;

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <HeroSection remainingInterviews={remainingInterviews} onUpgrade={onUpgrade} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <ProFeaturesSection onUpgrade={onUpgrade} />
